...
def compare_centroids(calculated_centroids, expected_centroids):
    # code to convert the calculated values according to the pre-decided values
    # converted to lists as well coz din know how to do the same stuff w ndarrays :))
    c = calculated_centroids.tolist()
    e = expected_centroids.tolist()
...
def compute_centroids_test(target):
    ...
    assert compare_centroids(centroids, expected_centroids), f"Wrong values. Expected: {expected_centroids}, got: {centroids}"
